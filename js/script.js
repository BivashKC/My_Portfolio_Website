...
// Create floating particles for tech background effect
...
function initializeAnimations() {
    ...
    const animatedElements = document.querySelectorAll(
        ...
        '.experience-card, .skill-category, .project-card, .cert-card, ' +
        '.activity-card, .contact-item, .contact-form'
    );
...
timelineStyle.textContent = timelineCSS;
